...
typedef struct message_0x02_t { 
    uint8_t  message_id ; /*  */
    uint8_t  software_type ; /* 00 = Reserved 01 = System code */
   } message_0x02_t;
  
  
typedef struct message_0x03_t { 
    uint8_t  message_id ; /*  */
    uint8_t  software_type ; /* 00 = Reserved 01 = System code */
   } message_0x03_t;
  
  
typedef struct message_0x04_t { 
    uint8_t  message_id ; /*  */
    uint8_t  type ; /* 00 = Reserved 01 = reboot after setting to factory defaults */
   } message_0x04_t;
  
  
typedef struct message_0x05_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x10_t { 
    uint8_t  message_id ; /*  */
   } message_0x10_t;
  
  
typedef struct message_0x11_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x2D_t { 
    uint8_t  message_id ; /*  */
   } message_0x2D_t;
  
  
typedef struct message_0x30_t { 
    uint8_t  message_id ; /*  */
    uint8_t  sv_ ; /* 0: means all SVs 1~32 : mean for the particular SV */
   } message_0x30_t;
  
  
typedef struct message_0x31_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x38_t { 
    uint8_t  message_id ; /*  */
   } message_0x38_t;
  
  
typedef struct message_0x39_t { 
    uint8_t  message_id ; /*  */
    uint8_t  position_pinning ; /* 0: disable (default) 1: enable */
   } message_0x39_t;
  
  
typedef struct message_0x3A_t { 
    uint8_t  message_id ; /*  */
   } message_0x3A_t;
  
  
typedef struct message_0x3B_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x3D_t { 
    uint8_t  message_id ; /*  */
   } message_0x3D_t;
  
  
typedef struct message_0x3E_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x3F_t { 
    uint8_t  message_id ; /*  */
   } message_0x3F_t;
  
  
typedef struct message_0x80_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0x83_t { 
    uint8_t  message_id ; /*  */
    uint8_t  ack_id ; /* Message ID of the request message */
   } message_0x83_t;
  
  
typedef struct message_0x84_t { 
    uint8_t  message_id ; /*  */
    uint8_t  ack_id ; /* Message ID of the request message */
   } message_0x84_t;
  
  
typedef struct message_0x86_t { 
    uint8_t  message_id ; /*  */
    uint8_t  update_rate ; /* 01: 1Hz */
   } message_0x86_t;
  
  
typedef struct message_0xA8_t { 
    uint8_t  message_id ; /*  */
...
typedef struct message_0xAE_t { 
    uint8_t  message_id ; /*  */
    uint16_t  datum_index ; /* Datum index Refer to Appendix A & B */
   } message_0xAE_t;
  
  
typedef struct message_0xB1_t { 
    uint8_t  message_id ; /*  */
    uint16_t  sv_id ; /* Satellite id */
    uint8_t  subframedata_0_0 ; /* Eph data subframe 1 */
    uint8_t  subframedata_0_1 ; /* Eph data subframe 1 */
...
typedef struct message_0xB3_t { 
    uint8_t  message_id ; /*  */
    uint8_t  waas_status ; /* 0: disable 1: enable */
   } message_0xB3_t;
  
  
typedef struct message_0xB4_t { 
    uint8_t  message_id ; /*  */
    uint8_t  status ; /* 0: disable 1: enable */
   } message_0xB4_t;
  
  
typedef struct message_0xB5_t { 
    uint8_t  message_id ; /*  */
    uint8_t  navigation_mode ; /* 0: car 1: pedestrian */
   } message_0xB5_t;
  
  
typedef struct message_0xB6_t { 
    uint8_t  message_id ; /*  */
